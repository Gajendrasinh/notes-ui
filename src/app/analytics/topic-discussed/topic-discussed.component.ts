...
@Component({
	selector: 'app-topic-discussed',
	templateUrl: './topic-discussed.component.html',
	styleUrls: ['./topic-discussed.component.scss'],
})
export class TopicDiscussedComponent implements OnInit {
	loaderId = analyticsConfig.LOADER_IDS.TOPIC_DISCUSSED;
